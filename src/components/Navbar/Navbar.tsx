...
const Navbar = () => {
  ...
  return (
    <motion.nav
      className="fixed top-0 w-screen z-10 duration-300 transition-opacity ease-in-out py-2"
      style={{
        backgroundColor: navBackgroundColor,
        opacity: navBackgroundOpacity,
      }}
    >
      <div className="container navbar flex justify-between m-auto px-4 2xl:px-0">
